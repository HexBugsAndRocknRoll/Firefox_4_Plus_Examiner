...
def writefiles(outputpath, places, historyvisits,inputhistory, bookmarks, cookies, signonslogin, signonsdisabled, formhistory, downloads):
    ...
    writer = csv.writer(open(historyvisitsfile, "w", encoding = "utf-8", newline=""),"excel-tab") 
    ...
    writer = csv.writer(open(inputhistoryfile, "w", encoding="utf-8", newline=""),"excel-tab")
    ...
    writer = csv.writer(open(bookmarksfile, "w", encoding = "utf-8", newline=""),"excel-tab")
    ...
    writer = csv.writer(open(cookiesfile, "w", encoding = "utf-8", newline=""),"excel-tab")
    ...
    writer = csv.writer(open(signonsfile, "w", encoding = "utf-8", newline=""),"excel-tab")
    ...
    writer = csv.writer(open(signonsdisabledfile, "w", encoding = "utf-8", newline=""),"excel-tab")
    ...
    writer = csv.writer(open(formhistoryfile, "w", encoding = "utf-8", newline=""),"excel-tab")
    ...
    writer = csv.writer(open(downloadsfile, "w", encoding = "utf-8", newline=""),"excel-tab")
...
#TODO: crack passwords, https://github.com/pradeep1288/ffpasscracker, http://www.mozilla.org/projects/security/pki/nss/
#TODO: Extensions.ini
#TODO: Stay Frosty!